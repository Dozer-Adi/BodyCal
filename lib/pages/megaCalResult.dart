...
class megaCalResult extends StatefulWidget{
  const megaCalResult({
  ...
  @override
  State<megaCalResult> createState() => _megaCalResultState();
}

class _megaCalResultState extends State<megaCalResult>{
                    ...
                    children: [
                      RichText(
                        text: TextSpan(
                            ...
                            children: [
                              TextSpan(text:'The Basic '),
                              TextSpan(text:'Protein ', style: h2(Color(0xfff9c727))),
                              TextSpan(text: 'Intake recommendations')
                            ]
                        ),
                      ),
                      SizedBox(height: 20,),
                      Text('At least: ',style: subText1White(),),
                      Text('${proteinNeeds['whoProtein']} grams/day',style: subText1Green()),
                      SizedBox(height: 10,),
                      Text( 'As per your requirement: ',style: subText1White(),),
